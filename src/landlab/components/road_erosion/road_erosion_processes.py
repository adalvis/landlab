...
class TruckPassErosion(Component):
    ...
    def run_one_step(self, tire_tracks): 
        ...
        for _ in range(self.truck_num):
            tire_tracks = tire_tracks(centerline, half_width)
